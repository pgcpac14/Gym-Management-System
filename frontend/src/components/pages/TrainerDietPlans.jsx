...
export default function TrainerDietPlans(){
    ...
    const loadData = () => {
        ...
        Promise.all([
            ...
            axiosInstance.get("/trainer/diet-plans")
    ...
    const handleSelect = (mid, dietPlanId) => {
    ...
    const doAssign = (mid) => {
        ...
        axiosInstance.put("/trainer/assign-diet-plan", { mid, dietPlanId: Number(dietPlanId) })
            .then(() => {
                setMsg("Diet plan assigned successfully.")
                loadData()
            })
            .catch(err => {
                console.log(err)
    ...
    return(
        <div>
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h3 className="text-primary mb-0">Members Diet Plan</h3>
