...
export default function CommonTrainerDashBoard(){
    const auth = useSelector(state => state.auth)
    return(
        <>
        <div className="dashboard-header d-flex justify-content-between align-items-center">
             <h3 className="fitcore-logo">🏋️ FitCore</h3>
            <span className="text-muted">Welcome, <strong>{auth.name}</strong> | Common Trainer</span>
        </div>
        <div className="d-flex">
            <div className="sidebar p-3">
                ...
                <ul className="nav nav-pills flex-column">
                    ...
                    <li className="nav-item">
                        <NavLink to="assigned-members" className="nav-link">Assigned Members</NavLink>
                    </li>
                    <li className="nav-item">
